            ...
            try {
                ...
                if (sender instanceof Player) {
                    if (args[2].startsWith("~")) {
                        g.fromX = Integer.parseInt(args[2].replace("~", "")) + (int) ((Player) sender).getLocation().getX();
                    }
                    if (args[3].startsWith("~")) {
                        g.fromY = Integer.parseInt(args[3].replace("~", "")) + (int) ((Player) sender).getLocation().getY();
                    }
                    if (args[4].startsWith("~")) {
                        g.fromZ = Integer.parseInt(args[4].replace("~", "")) + (int) ((Player) sender).getLocation().getZ();
                    }
                    if (args[5].startsWith("~")) {
                        g.toX = Integer.parseInt(args[5].replace("~", "")) + (int) ((Player) sender).getLocation().getX();
                    }
                    if (args[6].startsWith("~")) {
                        g.toY = Integer.parseInt(args[6].replace("~", "")) + (int) ((Player) sender).getLocation().getY();
                    }
                    if (args[7].startsWith("~")) {
                        g.toZ = Integer.parseInt(args[7].replace("~", "")) + (int) ((Player) sender).getLocation().getZ();
                    }
                } else {
